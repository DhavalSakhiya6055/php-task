...
if(isset($_POST['Submit']))
{
	...
	$lname=$_POST['price'];
	$contact=$_POST['upc'];
  $uid=intval($_GET['status']);
$query=mysqli_query($con,"update products set name='$name' ,price='$price' , upc='$upc' , status='$status' where id='$uid'");
                  ...
                  <div class="col-md-12">
                      ...
                      <p align="center" style="color:#F00;"><?php echo $_SESSION['msg'];?><?php echo $_SESSION['msg']=""; ?></p>
                          ...
                          <div class="form-group">
                              ...
                              <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">Universal Product Code </label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="email" value="<?php echo $row['email'];?>" readonly >
                              </div>
                          </div>
                               <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">Product Status </label>
                              <div class="col-sm-10">
