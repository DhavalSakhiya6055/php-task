...
{
$adminid=$_GET['id'];
$msg=mysqli_query($con,"delete from products where id='$adminid'");
if($msg)
{
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
	                  	  	  <h4><i class="fa fa-angle-right"></i> All Product Details </h4>
	                  	  	  <hr>
                              <thead>
                              <tr>
                                  <th>Sno.</th>
                              ...
                              <td><?php echo $cnt;?></td>
                                  ...
                                  <td>
                                     ...
                                     <a href="update-products.php?id=<?php echo $row['id'];?>"> 
